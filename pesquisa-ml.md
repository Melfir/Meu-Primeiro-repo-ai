...
### ♿ Observações de acessibilidade e estilo
- Evite usar emojis demais em parágrafos longos; mantenha-os para títulos ou listas.
- Se adicionar imagens, inclua sempre texto alternativo (alt) descritivo.
- Mantenha frases curtas e exemplos concretos — isso ajuda leitores mais jovens e iniciantes.

---

Se quiser, posso:
- abrir uma branch e criar um PR com esta versão (posso fazer o commit por você), ou
- gerar uma versão mais técnica com comandos e links diretos para notebooks de exemplo.
